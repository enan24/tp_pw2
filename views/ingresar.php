        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-4 login-sec'>
                    ...
                    <form action="../controllers/ingresar.php" method="post" class="login-form">
                        ...
                        <div class='form-check'>
                            <button type='button'value='volver' class='btn btn-login' onclick="goToHome()">Volver</button>
                ...
                <div class='col-md-8 banner-sec'>
                    <img class='d-block img-login' src='../resources/img/formula-de-la-ventas.png'
                        alt='ventas'>
                </div>
            </div>
        </div>
